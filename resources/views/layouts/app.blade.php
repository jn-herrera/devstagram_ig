...
<head>
    ...
    @stack('styles') <!--reservar el espacio para agregar hojas de estilo que no se requieran en todas las vistas -->
...
<body class="bg-gray-100">
    <header class="p-5 border-b bg-white shadow">
        <div class="container mx-auto flex justify-between items-center">
            <a href="{{route('home')}}" class="text-xl font-black">Devstagram</a>

            @auth
                <nav class="flex gap-2 items-center">

                    <a class="flex-items-centers gap-2 bg-white border p-2 text-gray-600 rounded text-sm uppercase
